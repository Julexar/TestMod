...
import net.julexar.testmod.client.ThirstHudOverlay;
import net.julexar.testmod.networking.ModMessages;
import net.julexar.testmod.networking.packet.DrinkWaterC2SPacket;
import net.julexar.testmod.util.KeyBinding;
